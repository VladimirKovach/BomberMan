...
const int BOMB_DEFAULT_TIMER = 15; // frame prima dell'esplosione (~3 sec a 60fps)
const int EXPLOSION_DURATION = 10;  // frame di persistenza del colore esplosione (~0.5 sec)
