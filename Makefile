...
chaser.o: src/chaser.cpp src/chaser.hpp src/map.hpp src/utils.hpp
	g++ -c src/chaser.cpp

enemy.o: src/enemy.cpp src/enemy.hpp src/map.hpp src/utils.hpp
	g++ -c src/enemy.cpp

game.o: src/game.cpp src/game.hpp src/level_manager.hpp src/level.hpp src/player.hpp src/renderer.hpp src/utils.hpp
	g++ -c src/game.cpp
...
level.o: src/level.cpp src/level.hpp src/bomb.hpp src/chaser.hpp src/item.hpp src/map.hpp src/roamer.hpp src/utils.hpp src/walker.hpp
	g++ -c src/level.cpp
...
player.o: src/player.cpp src/player.hpp src/item.hpp src/map.hpp src/utils.hpp
	g++ -c src/player.cpp

renderer.o: src/renderer.cpp src/renderer.hpp src/bomb.hpp src/item.hpp src/level_manager.hpp src/level.hpp src/player.hpp src/utils.hpp
	g++ -c src/renderer.cpp

roamer.o: src/roamer.cpp src/roamer.hpp src/map.hpp src/utils.hpp
	g++ -c src/roamer.cpp

utils.o: src/utils.cpp src/utils.hpp
	g++ -c src/utils.cpp

walker.o: src/walker.cpp src/walker.hpp src/map.hpp src/utils.hpp
	g++ -c src/walker.cpp
